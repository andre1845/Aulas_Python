...
# Ajuste este caminho para o local correto do seu arquivo
...
print(df.head())  # Adicione esta linha para ver o que foi lido
...
print(all_data)  # Adicione esta linha para verificar os dados extraídos
